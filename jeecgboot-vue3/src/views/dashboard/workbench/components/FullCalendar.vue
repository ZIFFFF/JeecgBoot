    ...
    <Card title="值班日历">
        ...
        <a-calendar v-model:value="value">
            ...
            <template #dateCellRender="{ current }">
                <div :class="{ 'other-month': !isCurrentMonth(current) }">
...
const keyDutys = ref<KeyDuty[]>([]);

// 获取重点值班范围
const getKeyDuty = async () => {
    try {
        const res = await keyDutyList();
        keyDutys.value = res.records.map((item: any) => ({
            name: item.name,
            start: item.startDate,
            end: item.endDate
        }));
    } catch (err: any) {
        createMessage.error('获取值班信息失败');
    }
};

let dutyName = '';
const isInKeyDuty = (current: Dayjs) => {
    for (let keyDuty of keyDutys.value) {
...
const dutyList: Duty[] = [
    { name: '孙汉明', date: '2025-01-26', type: '*', remarks: '', color: '#5dfff8' },
    { name: '范健科', date: '2025-01-26', type: '', remarks: '', color: '#5cd15c' },
    { name: '唐凯峰', date: '2025-01-26', type: '', remarks: '', color: '#339fff' },
    { name: '孙汉明', date: '2025-01-27', type: '*', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-01-28', type: '', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-01-30', type: '', remarks: '(14:30-22:30)', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-02', type: '*', remarks: '(08:30-22:30)', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-07', type: '*', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-10', type: '', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-14', type: '', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-18', type: '', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-22', type: '', remarks: '', color: '#5dfff8' },
    ...
    { name: '孙汉明', date: '2025-02-26', type: '*', remarks: '', color: '#5dfff8' },
...
const getListData = (current: Dayjs) => {
    ...
    return duties.map(duty => ({
        type: duty.type,
        content: `${duty.name}${duty.type} ${duty.remarks}`,
